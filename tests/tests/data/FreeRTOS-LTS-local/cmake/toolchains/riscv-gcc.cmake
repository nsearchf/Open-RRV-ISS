...
# Find GCC for ARM.
afr_find_compiler(AFR_COMPILER_CC riscv64-unknown-elf-gcc)
afr_find_compiler(AFR_COMPILER_CXX riscv64-unknown-elf-g++)
...
add_compile_options( -march=rv32i_zicsr -mabi=ilp32 -static -nostartfiles )
add_link_options( -march=rv32i_zicsr -mabi=ilp32 -static -nostartfiles )

# add_compile_options( -march=rv32i_zicsr -mabi=ilp32 -static )
# add_link_options( -march=rv32i_zicsr -mabi=ilp32 -static )
